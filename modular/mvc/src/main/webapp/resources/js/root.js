...
//var root = "CoderLeopard";
    ...
    if (typeof window.solxiom === "undefined") {
        window.solxiom = {};
    }
    //
    var paf = function() {
...
//        _self.root_path = location.protocol + "//" + location.host + "/vehicles";
        ...
        if (typeof window.solxiom.pafGames === "undefined") {
            window.solxiom.pafGames = {};
        }
        window.solxiom.pafGames.root_path = _self.root_path;// adding global variable root_path
    }
    /**
     * 
     * @returns {URL Params}
